          ...
          {activeView === 'dashboard' && (
            <>
              ...
              <div className="ad-profile-card">
                ...
                <button className="ad-btn-edit" onClick={() => navigate('/my-profile')}>
                  <i className="fa-solid fa-pen"></i> Open My Profile
                </button>
              </div>
                    ...
                    <div className="ad-event-content">
                      ...
                      <div style={{display:'flex', gap:6, marginTop:8}}>
                        ...
                        <button
                          ...
                          onClick={() => navigate(`/event-details/${ev.id}`, { state: { referrerView: 'dashboard', dashboardType: 'student' } })}
                          style={{flex:1}}
                        >
                          Details
                        </button>
                  ...
                  <div key={ev.id} className="ad-event-card">
                    ...
                    <div className="ad-event-content">
                      ...
                      <div style={{display:'flex', gap:8, marginTop:12}}>
                        ...
                        <button
                          className="ad-btn-view-details"
                          onClick={() => navigate(`/event-details/${ev.id}`, { state: { referrerView: 'events', dashboardType: 'student' } })}
                          style={{flex:1}}
                        >
