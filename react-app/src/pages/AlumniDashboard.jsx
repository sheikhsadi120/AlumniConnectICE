...
import { normalizeProfileResponse } from '../utils/profile-utils'
        ...
        <div className="ad-topbar">
          ...
          <div className="ad-topbar-right">
            ...
            {(profileAvatarUrl && !avatarLoadFailed)
              ? <img src={profileAvatarUrl} alt={profile.name} className="ad-topbar-profile-image" style={{cursor:'zoom-in'}} onError={() => setAvatarLoadFailed(true)} />
                    ...
                    <div className="ad-event-content">
                      ...
                      <div style={{display:'flex', gap:6, marginTop:8}}>
                        ...
                        <button
                          ...
                          onClick={() => navigate(`/event-details/${ev.id}`, { state: { referrerView: 'dashboard', dashboardType: 'alumni' } })}
                          style={{flex:1}}
                        >
                          Details
                        </button>
                  ...
                  <div key={ev.id} className="ad-event-card">
                    ...
                    <div className="ad-event-content">
                      ...
                      <div style={{display:'flex', gap:8, marginTop:12}}>
                        ...
                        <button
                          className="ad-btn-view-details"
                          onClick={() => navigate(`/event-details/${ev.id}`, { state: { referrerView: 'events', dashboardType: 'alumni' } })}
                          style={{flex:1}}
                        >
