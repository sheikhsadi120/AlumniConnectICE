...
function StudentRegister() {
  ...
  const [fields, setFields] = useState({
    ...
    student_id: '', session: '', hall_name: '', password: '', confirm_password: ''
  })
          ...
          <Row className="justify-content-center">
            <Col xs={12} sm={11} md={8} lg={6}>
              <div className="login-card">
                <h2><i className="fa-solid fa-user-plus me-2"></i>Student Register</h2>
                    ...
                    <Row>
                      <Col xs={12}>
                        <Form.Group className="mb-3 text-start">
                          <Form.Label>Full Name (as ID card)</Form.Label>
        ...
        <Modal.Body style={{ background: 'linear-gradient(135deg,#5f2c82,#a4508b)', color: '#fff', padding: '20px 28px' }}>
          ...
          <Row>
            <Col md={8}>
              ...
              <InfoRow label="Session" value={fields.session} />              <InfoRow label="Hall / College" value={fields.hall_name} />              <div style={{ display: 'flex', borderBottom: '1px solid rgba(255,255,255,0.15)', padding: '7px 0', gap: 8 }}>
